...
public static class GhostCache
{
    public static Ghost[] Ghosts { get; } = [
        new Ghost { Id = 1, Name = "Marshmallow Man", Type = "Manifestation", Age = 35, DateOfDead = new DateTime(1990, 5, 5), HauntLocation = "Downtown", Appearance = "Giant marshmallow", DangerLevel = 5, Abilities = "Size alteration, Resilience" },
        new Ghost { Id = 2, Name = "Slimer", Type = "Ectoplasmic", Age = 50, DateOfDead = new DateTime(1975, 6, 20), HauntLocation = "Sedgewick Hotel", Appearance = "Green blob with a big appetite", DangerLevel = 3, Abilities = "Eating, Making mess" },
        new Ghost { Id = 3, Name = "Lady in White", Type = "Spectral", Age = 100, DateOfDead = new DateTime(1925, 10, 31), HauntLocation = "Shandor Library", Appearance = "Pale woman in white dress", DangerLevel = 4, Abilities = "Invisibility, Wailing" },
